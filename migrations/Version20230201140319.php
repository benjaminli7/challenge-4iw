 ...
 */
final class Version20230201140319 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ALTER category_id TYPE INT');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE "article" ALTER category_id TYPE VARCHAR(255)');
